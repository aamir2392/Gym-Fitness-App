...
function BMICalculator() {
  ...
  const calculateBMI = (e) => {
    ...
    if (bmiValue < 18.5) {
      toast.warning(
        "You are underweight. Consider seeking advice from a healtcare provider"
      );
      ...
      toast.warning(
        "You are overweight. Consider seeking advice from a healtcare provider"
      );
    } else {
      toast.error(
